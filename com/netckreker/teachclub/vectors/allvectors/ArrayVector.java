...
public class ArrayVector  implements com.netckreker.teachclub.vectors.Vector {
    
        private double[] elements = null;
        private List<com.netckreker.teachclub.vectors.patterns.Observer> listeners = new ArrayList<com.netckreker.teachclub.vectors.patterns.Observer>();
        
        public void addObserver(com.netckreker.teachclub.vectors.patterns.Observer observer) {
              listeners.add(observer);
}
        
           public void notifyObjectModified(){
             for (com.netckreker.teachclub.vectors.patterns.Observer listener : listeners) { 
    ...
    public void Sum(com.netckreker.teachclub.vectors.Vector o1) throws IncompatibleVectorSizesException{
        ...
        if (this.elements.length != o1.getSize()){
            ...
            com.netckreker.teachclub.vectors.Vector o2 = new ArrayVector(getSize());
            for (int i=0;i<getSize();i++){
    ...
    public boolean equals(Object obj) {
        ...
        if (this == null)
            return false;
        if (!(obj instanceof com.netckreker.teachclub.vectors.Vector))
            return false;
        for (double it : elements) {
            if (it == getElement(i))
                i++;
    ...
    public Object clone() throws CloneNotSupportedException{
        com.netckreker.teachclub.vectors.Vector clone = null;
        clone = (com.netckreker.teachclub.vectors.Vector) super.clone();
