...
import com.npu.teachclub.vectors.*;
import java.util.*;
import java.io.*;

public class ArrayVector  implements com.npu.teachclub.vectors.Vector {
    
        private double[] elements = null;
        private List<com.npu.teachclub.vectors.Observer> listeners = new ArrayList<com.npu.teachclub.vectors.Observer>();
        
        public void addObserver(com.npu.teachclub.vectors.Observer observer) {
              listeners.add(observer);
}
        
           public void notifyObjectModified(){
             for (com.npu.teachclub.vectors.Observer listener : listeners) { 
    ...
    public void Sum(com.npu.teachclub.vectors.Vector o1) throws IncompatibleVectorSizesException{
        ...
        if (this.elements.length != o1.getSize()){
            ...
            com.npu.teachclub.vectors.Vector o2 = new ArrayVector(getSize());
            for (int i=0;i<getSize();i++){
    ...
    public boolean equals(Object obj) {
        ...
        if (this == null)
            return false;
        if (!(obj instanceof com.npu.teachclub.vectors.Vector))
            return false;
        for (double it : elements) {
            if (it == getElement(i))
                i++;
    ...
    public Object clone() throws CloneNotSupportedException{
        com.npu.teachclub.vectors.Vector clone = null;
        clone = (com.npu.teachclub.vectors.Vector) super.clone();
