...
public class ArrayVector  implements com.netcracker.teachclub.vectors.Vector {
    
        private double[] elements = null;
        private List<com.netcracker.teachclub.vectors.patterns.Observer> listeners = new ArrayList<com.netcracker.teachclub.vectors.patterns.Observer>();
        
        public void addObserver(com.netcracker.teachclub.vectors.patterns.Observer observer) {
              listeners.add(observer);
}
        
           public void notifyObjectModified(){
             for (com.netcracker.teachclub.vectors.patterns.Observer listener : listeners) { 
    ...
    public void Sum(com.netcracker.teachclub.vectors.Vector o1) throws IncompatibleVectorSizesException{
        ...
        if (this.elements.length != o1.getSize()){
            ...
            com.netcracker.teachclub.vectors.Vector o2 = new ArrayVector(getSize());
            for (int i=0;i<getSize();i++){
    ...
    public boolean equals(Object obj) {
        ...
        if (this == null)
            return false;
        if (!(obj instanceof com.netcracker.teachclub.vectors.Vector))
            return false;
        for (double it : elements) {
            if (it == getElement(i))
                i++;
    ...
    public Object clone() throws CloneNotSupportedException{
        com.netcracker.teachclub.vectors.Vector clone = null;
        clone = (com.netcracker.teachclub.vectors.Vector) super.clone();
