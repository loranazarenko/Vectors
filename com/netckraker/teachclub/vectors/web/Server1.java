...
public class Server1 
    {public static void main(String[] arg) {
        ...
        try {
         ...
         com.netckraker.teachclub.vectors.Vector o1 = new ArrayVector(size/2);
         com.netckraker.teachclub.vectors.Vector o2 = new ArrayVector(size/2);
         com.netckraker.teachclub.vectors.Vector o3 = new ArrayVector(size/2);
