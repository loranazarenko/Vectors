...
public class Server1 
    {public static void main(String[] arg) {
        ...
        try {
         ...
         com.netcracker.teachclub.vectors.Vector o1 = new ArrayVector(size/2);
         com.netcracker.teachclub.vectors.Vector o2 = new ArrayVector(size/2);
         com.netcracker.teachclub.vectors.Vector o3 = new ArrayVector(size/2);
         ...
         o3 = com.netcracker.teachclub.vectors.Vectors.Sum(o1, o2);
