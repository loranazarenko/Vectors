...
public class TabloWeb  {
    ...
    public Vector vector = new com.netckraker.teachclub.vectors.allvectors.ArrayVector();
    private boolean newed = false;
    private int cursor = 0;
       
    public TabloWeb(int size) {
        vector = new com.netckraker.teachclub.vectors.allvectors.ArrayVector(size);
    }
